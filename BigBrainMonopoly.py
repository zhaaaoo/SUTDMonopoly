...
def chance(player_id):
    ...
    # If "roll"
        ...
        if dice1 == dice2:
            players[player_id].update_sanity(cards[chosen].get_effect()[1])
            print ("You gobbled down your caifan like a vaccum cleaner. But you are fine!")
            ...
            if int(players[player_id].get_sanity()) < cards[chosen.get_effect()[1]:
                ...
                players[player_id].update_sanity(-cards[chosen].get_effect()[1])
                print ("You gobbled down your caifan like a vaccum cleaner and got food poisoning!")
                print ("Your sanity decreased by", cards[chosen].get_effect()[1], "sanity.")
